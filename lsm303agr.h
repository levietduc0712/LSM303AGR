/**
  ******************************************************************************
  * @file    lsm303agr.h
  * @author  MCD Application Team, Viet Duc
  * @version V1.0.3
  * @date    27-April-2024
  * @brief   This file contains all the functions prototypes for the lsm303agr.c driver.
  * @note    Viet Duc has contributed to the optimization of lsm303agr.h
  ******************************************************************************
  * @attention
  *
...
/** @defgroup Constants values
  * @{
  */
#define GRAVITY_EARTH (9.80665F) /**< Earth's gravity in m/s^2 */
#define GRAVITY_MOON (1.6F)      /**< The moon's gravity in m/s^2 */
#define GRAVITY_SUN (275.0F)     /**< The sun's gravity in m/s^2 */
...
/** @defgroup Acc_Full_Scale_Selection
  * @{
  */
#define LSM303AGR_ACC_SENSITIVITY_2G_LOW_POWER_MODE           ((uint8_t)16)  /*!< accelerometer sensitivity with 2 g full scale and low power mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_4G_LOW_POWER_MODE           ((uint8_t)31)  /*!< accelerometer sensitivity with 4 g full scale and low power mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_8G_LOW_POWER_MODE           ((uint8_t)63)  /*!< accelerometer sensitivity with 8 g full scale and low power mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_16G_LOW_POWER_MODE          ((uint8_t)188) /*!< accelerometer sensitivity with 12 g full scale and low power mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_2G_NORMAL_MODE              ((uint8_t)4)  /*!< accelerometer sensitivity with 2 g full scale and normal mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_4G_NORMAL_MODE              ((uint8_t)8)  /*!< accelerometer sensitivity with 4 g full scale and normal mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_8G_NORMAL_MODE              ((uint8_t)16)  /*!< accelerometer sensitivity with 8 g full scale and normal mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_16G_NORMAL_MODE             ((uint8_t)47) /*!< accelerometer sensitivity with 12 g full scale and normal mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_2G_HIGH_RESOLUTION_MODE     ((uint8_t)1)  /*!< accelerometer sensitivity with 2 g full scale and high resolution mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_4G_HIGH_RESOLUTION_MODE     ((uint8_t)2)  /*!< accelerometer sensitivity with 4 g full scale and high resolution mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_8G_HIGH_RESOLUTION_MODE     ((uint8_t)4)  /*!< accelerometer sensitivity with 8 g full scale and high resolution mode [mg/LSB] */
#define LSM303AGR_ACC_SENSITIVITY_16G_HIGH_RESOLUTION_MODE    ((uint8_t)12) /*!< accelerometer sensitivity with 12 g full scale and high resolution mode [mg/LSB] */
/**
  * @}
  */
